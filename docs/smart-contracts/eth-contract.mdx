...
sidebar_position: 2
---
import NewContract from "@site/src/components/blocks/eth-contract/new-contract";
import DefaultAccount from "@site/src/components/blocks/eth-contract/default-account";
import DefaultBlock from "@site/src/components/blocks/eth-contract/default-block";
import DefaultChain from "@site/src/components/blocks/eth-contract/default-chain";
